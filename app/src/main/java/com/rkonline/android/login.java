...
public class login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* en = (Button) findViewById(R.id.locale_english);
        hi = (Button) findViewById(R.id.locale_hindi);
        mr = (Button) findViewById(R.id.locale_marathi);*/
...
//        for marathi
    ...
    private void change_hi() {
        Locale locale = new Locale("hi");
        Locale.setDefault(locale);
        Configuration configuration = new Configuration();
        configuration.locale= locale;
        Context context = MyContextWrapper.wrap(this*//*in fragment use getContext() instead of this*//*, "hi");
        getResources().updateConfiguration(context.getResources().getConfiguration(), context.getResources().getDisplayMetrics());
    }

    private void change_mr() {
        Locale locale = new Locale("mr");
        Locale.setDefault(locale);
        Configuration configuration = new Configuration();
        configuration.locale= locale;
        Context context = MyContextWrapper.wrap(this*//*in fragment use getContext() instead of this*//*, "mr");
        getResources().updateConfiguration(context.getResources().getConfiguration(), context.getResources().getDisplayMetrics());
    }*/
}
